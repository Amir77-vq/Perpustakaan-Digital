    ...
    <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
      <div class="d-flex align-items-center w-100">
        ...
        <div class="text-end ms-auto">
          ...
          <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($totalPeminjaman); ?></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
      <div class="d-flex align-items-center w-100">
        ...
        <div class="text-end ms-auto">
          ...
          <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($sedangDipinjam); ?></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
      <div class="d-flex align-items-center w-100">
        ...
        <div class="text-end ms-auto">
          ...
          <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($totalPengembalian); ?></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
      <div class="d-flex align-items-center w-100">
        ...
        <div class="text-end ms-auto">
          ...
          <h4 class="mb-0 font-weight-bolder text-dark"> Rp <?php echo e(number_format(abs($totalDenda), 0, ',', '.')); ?></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
      <div class="card rekom-card shadow-sm" style="border-radius: 12px;">
        <div class="rekom-cover-wrapper" style="height: 245px; overflow: hidden; border-radius: 12px 12px 0 0;">
            <?php if($book->cover): ?>
                <img src="<?php echo e(asset('storage/cover/' . $book->cover)); ?>" class="w-100 h-100" style="object-fit: cover;">
            <?php else: ?>
        ...
        <div class="card-body p-3">
          <h6 class="mb-0 text-sm font-weight-bold text-dark text-truncate"><?php echo e($book->judul); ?></h6>
          <p class="text-xs text-secondary mb-2 text-truncate"><?php echo e($book->penulis); ?></p>
          
          <div class="d-flex justify-content-between align-items-center mt-3">
            <span class="d-flex align-items-center justify-content-center" 
                  style="background-color: <?php echo e($book->stok > 0 ? '#2dce89' : '#f5365c'); ?>; color: #fff; width: 80px; height: 30px; border-radius: 6px; font-size: 0.6rem; font-weight: 800; text-transform: uppercase; border: none;">
              <?php echo e($book->stok > 0 ? 'Tersedia' : 'Habis'); ?>

            </span>
            
            <a href="<?php echo e(route('buku.show', ['id' => $book->id, 'from' => 'dashboard'])); ?>" 
            ...
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr style="border-bottom: 1px solid #f8f9fa;">
                    <td class="ps-3 py-2">
                      <p class="text-xs font-weight-bold mb-0 text-dark"><?php echo e($loan->buku->judul ?? 'Buku Dihapus'); ?></p>
                    </td>
                    <td class="align-middle text-center py-2">
                      <div class="d-inline-block shadow-sm" style="width: 30px; height: 40px; background-color: #eee; border-radius: 3px; overflow: hidden;">
                        <?php if($loan->buku && $loan->buku->cover): ?>
                          
                          <img src="<?php echo e(asset('storage/cover/' . $loan->buku->cover)); ?>" class="w-100 h-100" style="object-fit: cover;">
                        <?php else: ?>
                    ...
                    <td class="align-middle text-center py-2">
                      <span class="badge shadow-sm" style="background-color: <?php echo e($color); ?>; color: #fff; border-radius: 8px; padding: 6px 12px; font-size: 9px; font-weight: 800; border: none;">
                    ...
                    <td class="align-middle text-center py-2">
                      <span class="text-secondary text-xxs font-weight-bold">
                        <?php echo e($loan->jatuh_tempo ? date('d/m/Y', strtotime($loan->jatuh_tempo)) : '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\perpustakaan-digital\resources\views/anggota/dashboard.blade.php ENDPATH**/ ?>