        ...
        <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
            <div class="d-flex align-items-center w-100">
                ...
                <div class="text-end ms-auto">
                    ...
                    <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($totalBuku); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
            <div class="d-flex align-items-center w-100">
                ...
                <div class="text-end ms-auto">
                    ...
                    <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($totalAnggota); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
            <div class="d-flex align-items-center w-100">
                ...
                <div class="text-end ms-auto">
                    ...
                    <h4 class="mb-0 font-weight-bolder text-dark"><?php echo e($peminjamanAktif); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-radius-xl p-3 stats-card-custom">
            <div class="d-flex align-items-center w-100">
                ...
                <div class="text-end ms-auto">
                    ...
                    <h4 class="mb-0 font-weight-bolder text-dark">Rp <?php echo e(number_format($dendaBelumDibayar, 0, ',', '.')); ?></h4>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #f8f9fa;">
                                <td class="ps-3 py-2">
                                    <p class="text-xs font-weight-bold mb-0 text-dark"><?php echo e($activity->user?->name ?? 'User Tidak Ditemukan'); ?></p>
                                </td>
                                <td class="ps-3 py-2">
                                ...
                                <td class="align-middle text-center py-2">
                                    ...
                                    <?php else: ?>
                                        <span class="badge" style="background-color: #f44335; color: #fff; border-radius: 4px; padding: 4px 8px; font-size: 8px; font-weight: 700;"><?php echo e(strtoupper($status)); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="align-middle text-center py-2">
                                    <span class="text-secondary text-xxs font-weight-bold">
                                        <?php echo e(\Carbon\Carbon::parse($activity->tanggal ?? $activity->created_at)->format('d/m/y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\perpustakaan-digital\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>