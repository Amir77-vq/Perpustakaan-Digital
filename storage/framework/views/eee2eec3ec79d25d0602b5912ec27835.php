                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-5 mb-4">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="ms-3">
                                        <h5 class="text-dark font-weight-bolder mb-0"><?php echo e($book->judul); ?></h5>
                                        <p class="text-sm text-muted mb-0">
                                            <span class="font-weight-bold text-dark">
                                                <?php echo e(date('ym')); ?>-B-<?php echo e(str_pad($book->id, 3, '0', STR_PAD_LEFT)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\perpustakaan-digital\resources\views/anggota/ajukan-denda.blade.php ENDPATH**/ ?>