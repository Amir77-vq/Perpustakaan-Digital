                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                                ...
                                <tr style="border-bottom: 1px solid #f2f2f2;">
                                    ...
                                    <td class="text-center">
                                        <?php if($item->status == 'WAITING'): ?>
                                            <span
                                                style="background-color: #fbc02d !important; color: #fff !important; font-size: 9px; padding: 4px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">WAITING</span>
                                        <?php elseif($item->status == 'TERLAMBAT' || $item->denda > 0): ?>
                                            <span
                                                style="background-color: #f5365c !important; color: #fff !important; font-size: 9px; padding: 4px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">TERLAMBAT</span>
                                        <?php else: ?>
                                            <span
                                                style="background-color: #2ecc71 !important; color: #ffffff !important; font-size: 9px; padding: 4px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">DIKEMBALIKAN</span>
                                        <?php endif; ?>
                                    </td>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-secondary text-sm">Data tidak ditemukan.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
