                                ...
                                <div class="d-flex gap-2 mt-5">
                                    @if($book->stok > 0)
                                        <a href="{{ route('buku.ajukan', ['id' => $book->id, 'from' => $dari]) }}"
                                            ...
                                            style="background: linear-gradient(310deg, {{ isset($statusBermasalah) && $statusBermasalah ? '#ea0606, #ff667c' : '#2152ff, #21d4fd' }}); border-radius: 8px; padding: 12px 30px; font-size: 0.8rem; border: none; font-weight: 700; box-shadow: none !important; text-transform: uppercase;">
                                            AJUKAN PEMINJAMAN
                                        </a>
                                    @endif
