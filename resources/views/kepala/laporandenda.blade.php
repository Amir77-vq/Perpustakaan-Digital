                                ...
                                <tbody>
                                    ...
                                    @forelse($peminjamans as $item)
                                        <tr style="border-bottom: 1px solid #f2f2f2;">
                                            <td class="ps-4">
                                                <span class="text-xs font-weight-bold text-dark">{{ $no++ }}</span>
                                            </td>
                                            <td class="ps-2">
                                                <p class="text-sm font-weight-bold mb-0">
                                                    {{-- Jalur lurus sesuai Controller --}}
                                            ...
                                            <td class="align-middle text-center">
                                                {{-- Pakai logic angka sesuai database lu --}}
                                                @if($item->status == 1 || strtoupper($item->status) === 'DIKEMBALIKAN')
